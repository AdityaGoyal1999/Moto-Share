  ...
  render () {
    return (
      <div id='cardsContainer'>
        <Card className='card'>
          <CardMedia class='media' image='./book.jpg' />
          <CardContent>
            <h2>Book a bike</h2>
        ...
        <Card className='card'>
          <CardMedia class='media' image='./pickup.jpg' />
          <CardContent>
        ...
        <Card className='card'>
          <CardMedia class='media' image='./return.jpg' />
          <CardContent>
        ...
        <Card className='card'>
          <CardMedia class='media' image='./bikelord.jpg' />
          <CardContent>
